-- 매사 성과 — 현재 현장을 팀장 추종(yeseong_worker_team_context)으로 결정
--   기존: v_worker.default_worksite_id만 참조 → 팀원(작업자)은 현장을 직접 갖지 않아
--         "현장 미설정"으로 입력 불가
--   변경: 출역과 동일하게 team_leader_id → 팀장 worker 행의 현장을 추종.
--         (팀장 미배정이면 본인 default_worksite_id 폴백 — team_context 내장 동작)

-- ============================================================
-- get_volumes_me — 현재 현장 = 팀장 추종
-- ============================================================
...
begin
  ...
  -- 팀장 추종: 팀원은 팀장의 현장을, 팀장/미배정자는 본인 현장을 따른다
...
-- ============================================================
-- replace_volumes_me — 현재 현장 판정도 팀장 추종
-- ============================================================
